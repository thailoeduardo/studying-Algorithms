...
const adjacencyMatrix = [
	[false], // Node 0 (unused)
	[false, true, true, false], // Node 1 (connected to nodes 2 and 3)
	[false, true, false, true], // Node 2 (connected to nodes 1 and 3)
	[false, false, true, false], // Node 3 (connected to node 2)
];

const startNode = 1; // Start from node 1

const shortestDistances = bfs(adjacencyMatrix, startNode);

console.log('Shortest distances from node', startNode, ':', shortestDistances);